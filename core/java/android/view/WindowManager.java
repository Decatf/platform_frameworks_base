...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams
         ...
         * {@hide}
         */
        public static final int PRIVATE_FLAG_STATUS_HIDE_FORCED = 0x00001000;
        /**
         * {@hide}
         */
        public static final int PRIVATE_FLAG_NAV_HIDE_FORCED = 0x00002000;
        /**
         * The window had not set FULLSCREEN flag so don't handle it as fullscreen in layoutWindowLw
         *
         * {@hide}
         */
        public static final int PRIVATE_FLAG_WAS_NOT_FULLSCREEN = 0x00004000;
